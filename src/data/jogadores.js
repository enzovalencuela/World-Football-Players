...
export const jogadores = [
  ...
  // Gabriel Menino
  {
    ...
    background: "plate",
    descricao:
      "Meio-campista versátil revelado na base do Palmeiras, capaz de atuar como volante, meia ou ala. Destaca-se pela capacidade de pressão, passes longos e chutes de média distância.",
