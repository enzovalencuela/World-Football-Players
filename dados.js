let dados = [
  ...
  // Niclas Füllkrug
  {
    ...
    time: "West Ham",
    tags: "futebol, alemanha, atacante, fullkrug, fulgrug",
    imagem:
  ...
  // Ronaldinho Gaúcho
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Substituir pelo logo de um dos times que ele jogou (ex: Barcelona, Milan)
    tags: "futebol, brasil, meia-atacante, habilidade, drible, alegria, magia",
    imagem:
    ...
    titulos:
      "Copa do Mundo, La Liga, Copa Libertadores, Copa América, Champions League, Mundial de Clubes",
    numero: "10",
    posicao: "Meia-atacante",
  ...
  // Ronaldo Fenômeno
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Você pode trocar por outro time que ele jogou (Inter de Milão, Barcelona, etc.)
    tags: "futebol, brasil, atacante, velocidade, gol, campeão mundial",
    imagem:
    ...
    titulos:
      "Copa do Mundo (2x), Copa Intercontinental, Copa UEFA, Serie A, La Liga, Copa do Brasil",
    numero: "9",
    posicao: "Atacante",
  ...
  // Vinícius Júnior
  {
    ...
    time: "https://upload.wikimedia.com/wikipedia/commons/thumb/3/38/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg",
    tags: "futebol, brasil, real madrid, atacante, velocidade",
    imagem:
    ...
    titulos: "La Liga, Liga dos Campeões",
    numero: "20",
    posicao: "Atacante",
  ...
  // William Arão
  {
    ...
    tags: "futebol, brasil, volante, marcação, força",
  ...
  // Zico
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Flamengo_RJ.svg/1200px-Flamengo_RJ.svg",
    tags: "futebol, brasil, meia, habilidade, gol, ídolo",
    imagem:
    ...
    titulos:
      "Campeonato Brasileiro, Copa Libertadores, Mundial de Clubes, Copa América",
    numero: "10",
    posicao: "Meia",
...

  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/SL_Benfica_logo.svg/1200px-SL_Benfica_logo.svg", // Substituir pela logo do atual time
    tags: "futebol, colômbia, atacante, artilheiro, força física",
    imagem:
...

  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/SL_Benfica_logo.svg/1200px-SL_Benfica_logo.svg", // Substituir pela logo do atual time
    tags: "futebol, colômbia, meia, visão de jogo, chutes",
    imagem:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Karim_Benzema_2018.jpg/220px-Karim_Benzema_2018.jpg", // Substituir por uma imagem do James
...

  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/SL_Benfica_logo.svg/1200px-SL_Benfica_logo.svg", // Substituir pela logo de um dos times que jogou
    tags: "futebol, colômbia, meia, elegante, cabelo loiro",
    imagem:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Karim_Benzema_2018.jpg/220px-Karim_Benzema_2018.jpg", // Substituir por uma imagem do Valderrama
...

  {
    ...
    imagem:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Karim_Benzema_2018.jpg/220px-Karim_Benzema_2018.jpg", // Substituir por uma imagem do Asprilla
  ...
  //Ivan Perišić
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Trocar pelo logo do time atual de Perišić
    tags: "futebol, croácia, ponta, versatilidade, cruzamento, chute de longa distância",
    imagem:
      "https://upload.wikimedia.org/wikipedia/commons/8/85/Ivan_Peri%C5%A1i%C4%87_%28cropped%29.jpg", // Trocar por uma imagem do Ivan Perišić
    titulos: "Bundesliga, Copa da Alemanha, Serie A, Coppa Italia",
    numero: "14",
  ...
  //Joško Gvardiol
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Chelsea_FC.svg/1200px-Chelsea_FC.svg", // Trocar pelo logo do Manchester City
    tags: "futebol, croácia, manchester city, zagueiro, defesa, jovem talento",
    imagem:
  ...
  //Luka Modrić
  {
    ...
    numero: "10",
    posicao: "Meia",
    dataNascimento: "9 de setembro de 1985",
    curiosidades:
  ...
  //Marcelo Brozović
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/Al_Nassr_FC.svg/1200px-Al_Nassr_FC.svg",
    tags: "futebol, croácia, al nassr, volante, força física, passe",
    imagem:
  ...
  //Mateo Kovačić
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Chelsea_FC.svg/1200px-Chelsea_FC.svg", // Substituir pelo logo do Manchester City
    tags: "futebol, croácia, manchester city, meio-campo, habilidade, passe",
    imagem:
  ...
  // Andreas Christensen
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/FC_Barcelona_crest.svg/1200px-FC_Barcelona_crest.svg",
    tags: "futebol, dinamarca, barcelona, zagueiro, defesa, liderança",
    imagem:
  ...
  // Christian Eriksen
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Manchester_United_FC.svg/1200px-Manchester_United_FC.svg",
    tags: "futebol, dinamarca, manchester united, meia, passe, gol",
    imagem:
  ...
  // Kasper Schmeichel
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Celtic_FC.svg/1200px-Celtic_FC.svg",
    tags: "futebol, dinamarca, celtic, goleiro, defesa, liderança",
    imagem:
  ...
  // Pierre-Emile Højbjerg
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Olympique_de_Marseille.svg/1200px-Olympique_de_Marseille.svg",
    tags: "futebol, dinamarca, marseille, meio-campo, volante, desarme",
    imagem:
      "https://media.gettyimages.com/id/1433653680/pt/foto/london-england-pierre-emile-hojbjerg-of-tottenham-hotspur-celebrates-after-scoring-their-teams.jpg?s=612x612&w=gi&k=20&c=XBWBRYSYSd-_3nTKvwiieFl2JNKO8rMw1A89mmE6R40=",
    titulos: "-", // Atualmente, Højbjerg não possui títulos individuais de grande destaque.
    numero: "23",
    posicao: "Meio-campista",
  ...
  // Andrew Robertson
  {
    ...
    time: "Liverpool FC",
    tags: "futebol, escocia, lateral, liverpool",
    imagem:
  ...
  // 3. Andrés Iniesta
  {
    ...
    tags: "futebol, espanha, barcelona, meia, habilidade",
    imagem:
  ...
  // David Silva
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d/Real_Betis_badge.svg/1200px-Real_Betis_badge.svg", // Adaptar para o time atual
    tags: "futebol, espanha, meia, silva",
    imagem:
  ...
  //Pablo Marí
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d/Real_Betis_badge.svg/1200px-Real_Betis_badge.svg", // Adaptar para o time atual
    tags: "futebol, espanha, zagueiro, mari",
    imagem:
  ...
  // Raúl González
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg",
    tags: "futebol, espanha, real madrid, atacante, eficiência",
    imagem:
  ...
  // Gavi
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/c/FC_Barcelona_crest.svg/1200px-FC_Barcelona_crest.svg",
    tags: "futebol, espanha, barcelona, meio-campo, jovem, talento",
    imagem:
  ...
  // Pedri
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/c/FC_Barcelona_crest.svg/1200px-FC_Barcelona_crest.svg",
    tags: "futebol, espanha, barcelona, meio-campo, jovem, talento, elegância",
    imagem:
  ...
  // Sergio Ramos
  {
    nome: "Sergio Ramos",
    descricao:
      "Zagueiro experiente e líder nato, Sergio Ramos é conhecido por sua força física, jogo aéreo e personalidade forte. É um dos maiores defensores da história do futebol.",
    pagina: "https://www.instagram.com/sergioramos/",
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Palmeiras_de_São_Paulo_logo.svg/1200px-Palmeiras_de_São_Paulo_logo.svg", // Adaptar para o time atual
    tags: "futebol, espanha, zagueiro, liderança, força, jogo aéreo",
    imagem:
      "https://conteudo.imguol.com.br/c/galeria/f2/2023/03/08/sergio-ramos-apos-a-derrota-do-psg-para-o-bayern-de-munique-na-champions-1678314320553_v2_3x4.jpg", // Trocar por uma imagem do Sergio Ramos
    titulos: "La Liga, Champions League, Copa do Mundo, Eurocopa",
    numero: "4",
    posicao: "Zagueiro",
  ...
  // Antoine Griezmann
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Substituir pela logo do atual time
  ...
  // Karim Benzema
  {
    nome: "Karim Benzema",
    descricao:
      "Um centroavante experiente e completo, conhecido por sua força física e finalização precisa.",
    pagina: "https://www.instagram.com/karimbenzema/",
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg",
    tags: "futebol, frança, real madrid, centroavante, força física",
    imagem:
  ...
  // Zinedine Zidane
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Paris_Saint-Germain_Logo.svg/1200px-Paris_Saint-Germain_Logo.svg", // Substituir pela logo do Real Madrid (carreira como jogador)
    tags: "futebol, frança, real madrid, meia, lenda",
    imagem:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCWOzZ1WGaa13WKzOzwcAWPGcWxYCPdEJzfA&s",
  ...
  // N'Golo Kanté
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Adaptar para o time atual
  ...
  // Ousmane Dembélé
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/c/FC_Barcelona_crest.svg/1200px-FC_Barcelona_crest.svg", // Adaptar para o time atual
  ...
  //Alexander-Arnold
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Tottenham_Hotspur_FC_logo.svg/1200px-Tottenham_Hotspur_FC_logo.svg", // Trocar pelo logo do Liverpool
    tags: "futebol, inglaterra, liverpool, lateral-direito, cruzamento, passe",
    imagem:
      "https://conteudo.imguol.com.br/c/esporte/ea/2019/05/07/trent-alexander-arnold-na-partida-liverpool-4-x-0-barcelona-1557265212095_v2_3x4.jpg", // Trocar por uma imagem do Trent Alexander-Arnold
  ...
  //Bukayo Saka
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Arsenal_FC.svg/1200px-Arsenal_FC.svg",
    tags: "futebol, inglaterra, arsenal, ponta, habilidade, jovem talento",
    imagem:
  ...
  //Declan Rice
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Chelsea_FC.svg/1200px-Chelsea_FC.svg", // Trocar pelo logo do Arsenal
    tags: "futebol, inglaterra, arsenal, volante, força, desarme",
    imagem:
  ...
  // Dele Alli
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/0/Everton_FC_badge.svg/1200px-Everton_FC_badge.svg", // Adaptar para o time atual
    tags: "futebol, inglaterra, meia-atacante, alli",
    imagem:
  ...
  //Jack Grealish
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Tottenham_Hotspur_FC_logo.svg/1200px-Tottenham_Hotspur_FC_logo.svg", // Trocar pelo logo do Manchester City
    tags: "futebol, inglaterra, manchester city, meia-atacante, habilidade, drible, paixão",
    imagem: "https://s.hs-data.com/bilder/spieler/gross/209502.jpg", // Trocar por uma imagem do Jack Grealish
    titulos: "Premier League",
    numero: "10",
    posicao: "Meia-atacante",
  ...
  //Marcus Rashford
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Trocar pelo logo do Manchester United
    tags: "futebol, inglaterra, manchester united, atacante, velocidade, gol, jovem talento",
    imagem:
  ...
  //Phil Foden
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Tottenham_Hotspur_FC_logo.svg/1200px-Tottenham_Hotspur_FC_logo.svg", // Trocar pelo logo do Manchester City
    tags: "futebol, inglaterra, manchester city, meia-atacante, habilidade, jovem talento",
    imagem:
  ...
  // Harry Kane
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Tottenham_Hotspur_FC_logo.svg/1200px-Tottenham_Hotspur_FC_logo.svg",
    tags: "futebol, inglaterra, atacante, gol, capitão",
    imagem:
  ...
  //Raheem Sterling
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Chelsea_FC.svg/1200px-Chelsea_FC.svg",
    tags: "futebol, inglaterra, chelsea, atacante, velocidade, habilidade",
    imagem:
  ...
  //Kyle Walker
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Tottenham_Hotspur_FC_logo.svg/1200px-Tottenham_Hotspur_FC_logo.svg", // Trocar pelo logo do Manchester City
    tags: "futebol, inglaterra, manchester city, lateral-direito, velocidade, força",
    imagem:
  ...
  // Ciro Immobile
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Adaptar para o time atual (ex: Lazio)
    tags: "futebol, itália, atacante, gol, serie_a, artilheiro",
    imagem:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBYMCEJGJE6UFDZ-lI42NGBJ7kSFMhwo3xjw&s", // Trocar por uma imagem do Ciro Immobile
    titulos: "Serie A, Copa da Itália",
    numero: "17",
    posicao: "Atacante",
  ...
  // Federico Chiesa
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Adaptar para o time atual (ex: Juventus)
    tags: "futebol, itália, atacante, velocidade, drible, jovem",
    imagem:
      "https://tntsports.com.br/__export/1724858906305/sites/esporteinterativo/img/2022/01/10/juventus-chiesa_1.jpg_742406227.jpg", // Trocar por uma imagem do Federico Chiesa
  ...
  //Gianluigi Buffon
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Palmeiras_de_São_Paulo_logo.svg/1200px-Palmeiras_de_São_Paulo_logo.svg", // Adaptar para o time atual
    tags: "futebol, itália, goleiro, lenda, reflexos, liderança",
    imagem:
  ...
  // Gianluigi Donnarumma
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Adaptar para o time atual
    tags: "futebol, itália, goleiro, jovem, talento, reflexos",
    imagem:
  ...
  // Leonardo Bonucci
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Adaptar para o time atual (ex: Juventus)
    tags: "futebol, itália, zagueiro, liderança, passes, jogo_aéreo",
    imagem:
      "https://i.pinimg.com/736x/41/d4/94/41d494ec9223d92594c5a3c14b19bbaa.jpg", // Trocar por uma imagem do Leonardo Bonucci
  ...
  // Nicolo Barella
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Adaptar para o time atual (ex: Inter de Milão)
    tags: "futebol, itália, meio_campo, energia, desarme, ataque",
    imagem:
  ...
  //Erling Haaland
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Adaptar para o time atual (ex: Manchester City)
    tags: "futebol, noruega, atacante, gol, velocidade, força",
    imagem:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqXDguxHKB07pNjYPfZNPzpTaG1E6xeUrxYA&s", // Trocar por uma imagem do Erling Haaland
    titulos: "Bundesliga, Champions League",
    numero: "9",
    posicao: "Atacante",
  ...
  // Gareth Bale
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Adaptar para o time atual (ex: Los Angeles FC)
    tags: "futebol, gales, extremo, velocidade, chute, gol_de_falta",
    imagem:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRRjKZDd0bA5i4_ngoeRr8b0Pn2xuvp_lx1w&s", // Trocar por uma imagem do Gareth Bale
  ...
  // Arkadiusz Milik
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Juventus_FC.svg/1200px-Juventus_FC.svg",
    tags: "futebol, polônia, atacante, gol, serie_a, força",
    imagem:
  ...
  // Kamil Glik
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Palmeiras_de_São_Paulo_logo.svg/1200px-Palmeiras_de_São_Paulo_logo.svg", // Adaptar para o time atual (ex: Cracóvia)
    tags: "futebol, polônia, zagueiro, força, liderança, jogo_aéreo",
    imagem:
  ...
  // Piotr Zieliński
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Palmeiras_de_São_Paulo_logo.svg/1200px-Palmeiras_de_São_Paulo_logo.svg", // Adaptar para o time atual (Inter de Milão)
    tags: "futebol, polônia, meio_campo, habilidade, visão_de_jogo, passes",
    imagem:
      "https://media.gettyimages.com/id/1473779721/pt/foto/naples-italy-piotr-zielinski-of-ssc-napoli-celebrates-after-scoring-the-teams-third-goal.jpg?s=612x612&w=gi&k=20&c=lkR7XtUsqIqt_7BeokafJU0LgcVxVaQ6jQRHCvUg_Qg=", // Trocar por uma imagem do Piotr Zieliński
    titulos: "Serie A, Copa da Itália",
    numero: "7",
    posicao: "Meio-campista",
  ...
  // Robert Lewandowski
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Adaptar para o time atual (ex: Barcelona)
    tags: "futebol, polônia, atacante, gol, força, inteligência",
    imagem:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTv0m5gGaMmARcCLNop3IH4Wjnaqk5ktAs9tkUkyuUZqTwhuDBTMg3zchMHqbzWg4fJ8NU&usqp=CAU", // Trocar por uma imagem do Robert Lewandowski
  ...
  // Wojciech Szczęsny
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Adaptar para o time atual (ex: Juventus)
    tags: "futebol, polônia, goleiro, juventus, defesa, liderança",
    imagem:
      "https://i.pinimg.com/474x/ec/80/1f/ec801f3925e34507b0869cc625193d3c.jpg", // Trocar por uma imagem do Wojciech Szczęsny
    titulos: "Serie A, Copa da Itália",
    numero: "1",
    posicao: "Goleiro",
  ...
  //Eusébio
  {
    nome: "Eusébio",
    descricao:
      "Considerado um dos maiores jogadores de todos os tempos, Eusébio era conhecido por sua velocidade, dribles, chutes poderosos e faro de gol. Era um verdadeiro craque e ídolo das multidões.",
    pagina: "Não possui perfil oficial nas redes sociais", // Eusébio faleceu em 2014
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/SL_Benfica.svg/1200px-SL_Benfica.svg", // Principal time da carreira
    tags: "futebol, portugal, lenda, gol, velocidade, drible",
    imagem:
      "https://external-preview.redd.it/b24-10-years-without-the-king-eus%C3%A9bio-10-years-of-saudade-v0-gRIms1Rw7fiI-CLDbCmRhomSus9z9mAwngfR4PgxqNo.jpg?auto=webp&s=25a749ad2c58d95399ca681c9343bc9125d709d2", // Trocar por uma imagem do Eusébio
    titulos:
      "Campeonato Português <br> Taça de Portugal <br> Taça dos Campeões Europeus <br> Bola de Ouro",
    numero: "13",
    posicao: "Atacante",
  ...
  //Ibrahimović
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Adaptar para o time atual (ex: Milan)
    tags: "futebol, suécia, atacante, força, técnica, personalidade",
    imagem:
    ...
    titulos: "Serie A, Ligue 1, Eredivisie, Copa da Itália, Supercopa Italiana",
    numero: "11",
    posicao: "Atacante",
  ...
  // Luis Suárez
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/SL_Benfica_logo.svg/1200px-SL_Benfica_logo.svg", // Substituir pela logo do atual time
    tags: "futebol, uruguai, atacante, habilidade, gols",
    imagem:
  ...
  // Edinson Cavani
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/SL_Benfica_logo.svg/1200px-SL_Benfica_logo.svg", // Substituir pela logo do atual time
    tags: "futebol, uruguai, atacante, força, gols",
    imagem:
  ...
  // Diego Godín
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Tottenham_Hotspur_FC_logo.svg/1200px-Tottenham_Hotspur_FC_logo.svg", // Substituir pela logo do atual time
  ...
  // Gustavo Scarpa
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Juventus_FC_logo.svg/1200px-Juventus_FC_logo.svg", // Adaptar para o logo do Atlético Mineiro
    tags: "futebol, brasil, atletico_mineiro, meia, tecnica, passes",
    imagem: "https://atletico.com.br/wp-content/uploads/2023/07/Scarpa.png", // Trocar por uma imagem do Gustavo Scarpa
  ...
  // Hulk
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Juventus_FC_logo.svg/1200px-Juventus_FC_logo.svg", // Adaptar para o logo do Atlético Mineiro
    tags: "futebol, brasil, atletico-mg, atacante, força, velocidade",
    imagem: "https://www.galodigital.com.br/w/images/2/2f/Hulk2023b.png", // Trocar por uma imagem do Hulk
  ...
  //Alex Sandro
  {
    ...
    imagem:
      "https://images.flamengo.com.br/public/images/players/4/1726081099.jpg", // Substitua pela imagem do Alex Sandro
    tags: "Brasil, Flamengo, Alex Sandro, lateral-esquerdo, experiência, Europa",
    numero: 13,
    posicao: "Lateral-esquerdo",
  ...
  // Carlinhos
  {
    ...
    pagina: "#", // Atualize com o link correto
    imagem:
      "https://images.flamengo.com.br/public/images/players/7/1725043943.png",
    tags: "Brasil, Flamengo, Carlinhos, atacante, versátil, força física",
    numero: "22",
    posicao: "Atacante",
  ...
  // Carlos Alcaraz
  {
    ...
    imagem:
      "https://images.flamengo.com.br/public/images/players/6/1726080833.jpg",
  ...
  //Fabrício Bruno
  {
    ...
    imagem:
      "https://images.flamengo.com.br/public/images/players/2/1710271630.png", // Substitua pela imagem do Fabrício Bruno
    tags: "Brasil, Flamengo, Fabrício Bruno, zagueiro, força física, liderança",
    numero: "3",
    posicao: "Zagueiro",
  ...
  //Léo Ortiz
  {
    ...
    imagem:
      "https://images.flamengo.com.br/public/images/players/9/1710431451.png",
    tags: "Brasil, Flamengo, Léo Ortiz, zagueiro, técnica, visão de jogo",
    numero: "4",
    posicao: "Zagueiro",
  ...
  // Luiz Araújo
  {
    ...
    pagina: "#", // Atualize com o link correto
    imagem:
      "https://images.flamengo.com.br/public/images/players/7/1710273652.png",
    tags: "Brasil, Flamengo, Luiz Araújo, atacante, habilidoso, rápido",
    numero: "7",
    posicao: "Atacante",
  ...
  //Matías Viña
  {
    ...
    tags: "Uruguai, Flamengo, Matías Viña, lateral-esquerdo, cruzamentos, marcação",
    numero: "22",
    posicao: "Lateral-esquerdo",
  ...
  // Matheus Gonçalves
  {
    ...
    imagem:
      "https://images.flamengo.com.br/public/images/players/6/1710273017.png", // Substitua pela imagem do Matheus Gonçalves
    tags: "Brasil, Flamengo, Matheus Gonçalves, meia, base, jovem",
    numero: "10",
    posicao: "Meia",
  ...
  // Cano
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/75/%C3%81ngel_Di_Mar%C3%ADa_2022.jpg/220px-%C3%81ngel_Di_Mar%C3%ADa_2022.jpg", // Adaptar para o logo do Fluminense
    tags: "futebol, brasil, fluminense, atacante, artilheiro, argentina",
    imagem:
      "https://s3.amazonaws.com/assets-fluminense/player_pictures/1751/GERMAN_CANO-SITE_profile.png?1720705247", // Trocar por uma imagem do Germán Cano
  ...
  //Marcelo
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg", // Adaptar para o time atual, se aplicável
    tags: "futebol, brasil, real_madrid, lateral_esquerdo, habilidade, drible, cruzamento",
    imagem:
      "https://i.pinimg.com/736x/9f/d5/87/9fd587b97780c61629ec5933895a43db.jpg", // Trocar por uma imagem do Marcelo
    titulos: "La Liga, Champions League, Copa do Mundo de Clubes, Copa América",
  ...
  // Rodrigo Caio
  {
    ...
    time: "Flamengo",
    tags: "futebol, brasil, zagueiro, gremio",
    imagem:
  ...
  // Renê
  {
    ...
    time: "Internacional",
    tags: "futebol, brasil, lateral-esquerdo, internacional, rene",
    imagem:
  ...
  // Raphael Veiga
  {
    ...
    time: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Palmeiras_de_São_Paulo_logo.svg/1200px-Palmeiras_de_São_Paulo_logo.svg",
    tags: "futebol, brasil, palmeiras, meia, gol, habilidade",
    imagem:
      "https://www.verdazzo.com.br/wp-content/uploads/2020/03/raphael-veiga.jpg", // Trocar por uma imagem do Raphael Veiga
  ...
  // Philippe Coutinho
  {
    ...
    time: "Vasco da Gama",
    tags: "futebol, brasil, vasco, meia",
    imagem:
